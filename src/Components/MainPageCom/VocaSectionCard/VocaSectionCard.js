        ...
        <div className="h-full w-full overflow-auto animate-smoothy">
            <div className='flex flex-row justify-end'>
                <div className='mt-auto mb-auto'>
                    <Back
                        className='active:animate-backclick'
                        onClick={() => {
                            backToMain();
                        }}></Back>
                </div>
                <div
                    className="relative block w-2/4 ml-auto mr-auto mb-3 mt-3 pr-[40px] text-center">
                    <p
                        className="mb-0 text-2xl font-extrabold tracking-tight leading-none text-gray-900 md:text-3xl lg:text-4xl dark:text-gray-400">{listData.list}</p>
                </div>
            </div>
            <CardMake></CardMake>
            <CardModal></CardModal>
