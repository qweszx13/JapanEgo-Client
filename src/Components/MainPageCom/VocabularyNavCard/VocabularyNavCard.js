...
vocaListData.push({list: 'last', isLast: true}); //더미 끝
        ...
        <div className='h-full w-full overflow-auto animate-smoothy'>
            <InfiniteScroll
                ...
                <label className="relative block w-3/4 ml-auto mr-auto mb-3 mt-3 text-center">
                    <ruby>
                        <p
                            className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-gray-400">私のリスト</p>
                        ...
                        <List.Item>
                            {
                                item.isLast !== true
                                    ...
                                    : <Popconfirm title={<Input showCount maxLength = {
                                                20
                                            }
                                            ref = {
                                                createListInputRef
                                            ...
                                            onChange = {
                                                (e) => {
                                                    setCreateListInputNum(e.target.value);
                                                }
                                            } //state 값 변경
                                            value = {
                                                createListInputNum
                                            ...
                                            //value 값 state이용
                                            icon={<FileAddOutlined style = {{top:'25%',color: 'blue' }}/>} okText="작성" cancelText="취소" onConfirm={() => {
