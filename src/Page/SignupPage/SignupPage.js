...
export default function SignupPage() {
    ...
    return (
        <div
            className="relative overflow-hidden bg-white w-full h-full flex-col justify-center">
            <div className="mx-auto max-full">
                <div
                    ...
                    <svg
                        className="absolute inset-y-0 right-0 hidden h-full w-40 translate-x-1/2 transform text-white lg:block lg:w-68"
                        fill="currentColor"
                        viewBox="0 0 100 100"
                    ...
                    <Popover>
                        <div className="relative px-4 pt-6 pl-0 sm:px-6 lg:px-8">
                            <nav
                                ...
                                <div className="flex flex-shrink-0 flex-grow items-center lg:flex-grow-0">
                                    <div className="flex w-full items-center justify-between md:w-auto">
                                        ...
                                        <div className="-mr-2 flex items-center md:hidden">
                                            <Popover.Button
                                                className="inline-flex items-center justify-center rounded-md bg-white p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-[#222a6e]">
                                ...
                                <div className="hidden md:ml-5 md:block md:space-x-8 md:pr-4">
                                    {
                                        navigation.map((item) => (
                                            <a
                                                key={item.name}
